import java.util.ArrayList; import java.util.concurrent.TimeUnit; import java.util.Scanner; import java.util.Collections;
/**
...
{  
    ...
    boolean running = true; boolean playing = true;
    ...
    System.out.println(playNum + " players? Alright, please enter their names in turn order.");
    ...
    while (playing = true){    
        while (running = true){
            ...
            if (plNameList.contains(shooter)){
                   ...
                   System.out.println("Alright, " + plNameList.get(0) + " will be the shooter.");
                   break;
            }
            else{
        ...
        for (int i=0; i < playNum; i++){
            while (running = true){
                System.out.println(plNameList.get(i) + " has a balance of $"+ playerList.get(i).getBal() +". Would they like to make a bet? Yes / No");
                String betChoice = scanner.nextLine();
                if (betChoice.equals("Yes")){
                     while (running = true){
                         System.out.println("Would they like to bet on 'Pass' or 'Don't Pass'?");
                         ...
                         if (passChoice.equals("Pass")){
                             ...
                             System.out.println("I cannot recognise that input. Make sure it is caps sensitive and try again.");
                         }
                     }
                }
        ...
        System.out.println("Currently there is $" + passPool + " on 'Pass' and $" + noPassPool + " on 'Don't Pass'!");
        boolean pass = true;
        ...
        switch (rollSum){
            case 7: 
            case 11:{   
                System.out.println("Shooter Wins!"); TimeUnit.MILLISECONDS.sleep(500); break;
            }
            case 2:
            case 3:
            case 12:{
                System.out.println("Shooter loses!"); TimeUnit.MILLISECONDS.sleep(500);
                pass = false; break;
            }
            default:{
                ...
                while (running){
                    ...
                    if (rollSum == pointNum){
                        ...
                        System.out.println("Out 7! Shooter Loses!"); TimeUnit.MILLISECONDS.sleep(500); 
                        pass = false; break;
                    }
        ...
        for (int i=0; i < playNum; i++){
            if (playerList.get(i).checkPass() == (pass)){
                ...
                System.out.println(plNameList.get(i) + " wins " + addBet + " dollars! They now have a balance of $" + playerList.get(i).getBal() + "!"); TimeUnit.MILLISECONDS.sleep(500);
            }
            else{
                int addBet = playerList.get(i).checkBet() * -1;
                playerList.get(i).updateBal(addBet);
                System.out.println(plNameList.get(i) + " loses " + addBet + " dollars! They now have a balance of $" + playerList.get(i).getBal() + "!"); TimeUnit.MILLISECONDS.sleep(500);
            }
        }
    }
}   
